...
private slots:
    ...
    void on_spinBox_hex0_valueChanged(int val);

    void on_spinBox_hex1_valueChanged(int val);

    void on_spinBox_hex2_valueChanged(int val);

    void on_spinBox_hex3_valueChanged(int val);

    void on_spinBox_hex4_valueChanged(int val);

    void on_spinBox_hex5_valueChanged(int val);
